...
<div class="flex-grow-1">
    ...
    <a href="#" class="{{ request()->is('services*') ? 'active-link' : '' }}"><i class="fas fa-heartbeat me-2"></i>Health Services</a>
    <a href="#" class="{{ request()->is('reports*') ? 'active-link' : '' }}"><i class="fas fa-file-alt me-2"></i>Reports</a>
</div>
